          ...
          <div className="py-3">
            <ul className="flex gap-10">
              <li className="flex items-center gap-2">
                ...
                <h3 className="flex text-[#787A80] text-sm gap-1 leading-6 items-center"><span className="pr-1">50</span>Comment</h3> 
                </div>
              </li>
              <li className="flex items-center gap-2">
                <div className="w-[15px] h-[18px]">
                ...
                <div className="flex">
                <h3 className="flex text-[#787A80] text-sm gap-1 leading-6 items-center"><span className="pr-1">50</span>Đã bán</h3> 
                </div>
              </li>
            </ul>
          </div>
