    ...
    <div className="box-container flex h-[250px] rounded-lg mt-6">
      ...
      <div className="container h-full grid grid-cols-4 bg-[#FFFFFF]">
        {listItems.map((item, index) => (
          <div
            key={index}
            className="flex items-center justify-between px-14 border-secondary [&:nth-child(4)]:rounded-tr-lg last:rounded-br-lg justify-center col-span-1 group hover:cursor-pointer hover:border-[#0D6EFD]"
            onClick={() =>
              route.push({
